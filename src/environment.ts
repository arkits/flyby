  ...
  switch (mapVariant) {
    ...
    case "san-francisco":
      return {
        ...
        sky: {
          mode: "hazy",
          topColor: colorFromRGB(106, 134, 176),
          horizonColor: colorFromRGB(198, 206, 214),
          bottomColor: colorFromRGB(176, 178, 176),
          curve: 1.16,
          glow: 0.08,
        },
        cloud: {
          color: colorFromRGB(226, 230, 232),
          shadowColor: colorFromRGB(156, 164, 170),
          coverage: 0.62,
          softness: 0.72,
          scale: 0.0009,
          bandScale: 1.4,
        ...
        keyLight: {
          direction: normalizeDirection(0.48, 0.64, -0.26),
          color: colorFromRGB(255, 246, 228),
          intensity: 0.88,
          shadowStrength: 0.45,
        },
        hemisphere: {
          skyColor: colorFromRGB(154, 174, 194),
          groundColor: colorFromRGB(104, 108, 110),
          intensity: 0.62,
          balance: 0.6,
        },
        fog: {
          color: colorFromRGB(188, 196, 206),
          start: 760,
          end: 4300,
          density: 1.24,
          heightFalloff: 0.00085,
        },
        ground: {
          primary: colorFromRGB(110, 122, 104),
          secondary: colorFromRGB(142, 140, 132),
          accent: colorFromRGB(168, 96, 64),
          paved: colorFromRGB(104, 108, 114),
          detailScale: 0.018,
          breakupScale: 0.0046,
          stripScale: 0.009,
          patchScale: 0.024,
